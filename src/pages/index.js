    ...
    <Layout title={`Hello from ${siteConfig.title}`} description="Description will go into a meta tag in <head />">
      <header className={clsx("hero hero--primary", styles.heroBanner)}>
        <div className="container">
          ...
          <div className={styles.buttons}>
            <Link className={styles.logo} to={useBaseUrl("docs/")}>
              <img src="https://raw.githubusercontent.com/CKGrafico/Frontend-Boilerplates/docs/resources/logo/logo.png" alt="Logo Boilerplate" width="150" />
            </Link>
          </div>
        </div>
      </header>
      <main>
        <p className={styles.logos} align="center">
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/vue")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/react")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/ts")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/phaser")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/cypress")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/nuxt")}>
          ...
          <Link className={styles.logo} to={useBaseUrl("docs/node-ts")}>
